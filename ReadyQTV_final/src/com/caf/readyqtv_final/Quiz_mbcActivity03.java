...
public class Quiz_mbcActivity03 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    setContentView(R.layout.activity_quiz_mbc03);
...
class AccumulateTask extends AsyncTask <Integer, Integer, Integer> {
		...
		protected void onPostExecute(Integer result) {
			if(mProgressStatus == 101) {
				Log.v("five","five");
				Intent intent_pg = new Intent(Quiz_mbcActivity03.this, Quiz_mbcActivity04.class);
