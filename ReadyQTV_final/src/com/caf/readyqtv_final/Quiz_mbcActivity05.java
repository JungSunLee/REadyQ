...
public class Quiz_mbcActivity05 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    setContentView(R.layout.activity_quiz_mbc05);
...
class AccumulateTask extends AsyncTask <Integer, Integer, Integer> {
		...
		protected void onPostExecute(Integer result) {
			if(mProgressStatus == 101) {
				Log.v("five","five");
				Intent intent_pg = new Intent(Quiz_mbcActivity05.this, Quiz_mbcActivity06.class);
